# -*- coding: utf-8 -*-
"""Spanish homepage copy. Transcreated, not translated — the English lines are
written, and a literal rendering goes flat. Where a line trades on English rhythm
it has been rewritten as a Spanish line that does the same job.

Patient reviews are NOT translated: they are quoted verbatim from real people.
They stay in their original language and are labelled."""
...
"Any surgeon can do the operation.": "Cualquier cirujano puede operar.",
"What happens after is what matters.": "Lo que pasa después es lo que importa.",
"How he plans the after": "Cómo planifica el después",
...
"Start with what bothers you, not with a procedure name. Every plan begins with a conversation about proportion — yours, not a template.":
  "Empiece por lo que le molesta, no por el nombre de un procedimiento. Todo plan empieza con una conversación sobre proporción &mdash; la suya, no una plantilla.",
}
...
"Pittsburgh Post-Gazette, 2019": "Pittsburgh Post-Gazette, 2019",
"Read his story": "Lea su historia",
"&mdash;&nbsp;Julio Clavijo Alvarez, MD. Board-certified plastic surgeon, Miami. Doctorate in surgical research &mdash; Harvard University, then the University of Pittsburgh.":
  "&mdash;&nbsp;Julio Clavijo Alvarez, MD. Cirujano plástico certificado, Miami. Doctorado en investigación quirúrgica &mdash; Universidad de Harvard, después la Universidad de Pittsburgh.",
"I&rsquo;m integrating all that knowledge that is going to benefit you &mdash; to improve the quality of your healing after cosmetic surgery.":
  "Estoy integrando todo ese conocimiento en beneficio suyo &mdash; para mejorar la calidad de su recuperación después de la cirugía estética.",
"They told me I could become a surgeon. I could become a researcher, and maybe a businessman. &hellip; I have become all three.":
  "Me dijeron que podía ser cirujano. Que podía ser investigador, y quizá empresario. &hellip; Me convertí en los tres.",

# ---- reviews ----
"In their words": "En sus palabras",
"The part nobody photographs.": "La parte que nadie fotografía.",
"Every quote below is verbatim from": "Cada testimonio es textual, tomado de",
"his RealSelf profile": "su perfil de RealSelf",

# ---- instagram ----
"Instagram": "Instagram",
"148,000 people follow him for the answers.": "148.000 personas lo siguen por las respuestas.",
"Follow on Instagram &rarr;": "Seguir en Instagram &rarr;",
"View on Instagram &rarr;": "Ver en Instagram &rarr;",

# ---- video library ----
"The library": "La videoteca",
...
# ---- location ----
"Visit": "Visítenos",
"Come see the room first.": "Venga a conocer el consultorio primero.",
"Address": "Dirección",
"Call us": "Llámenos",
"Email": "Correo",
...
"&copy; 2026 J.C. Alvarez Plastic Surgery &middot; Julio Clavijo Alvarez, MD":
  "&copy; 2026 J.C. Alvarez Plastic Surgery &middot; Julio Clavijo Alvarez, MD",

# ---- procedure names used in cards/labels ----
"Breast Lift & Augmentation": "Levantamiento y aumento de senos",
...
T.update({
# ---- reviews intro ----
"A gallery shows you the result. It can&rsquo;t show you whether he listened, what the recovery actually felt like, or whether he talked you out of something.":
...
"Profile view of a marked waist and hip before body contouring":
  "Vista de perfil de una cintura y cadera marcadas antes del contorno corporal",
...
"Gloved hands marking the incision plan for a breast lift with augmentation":
  "Manos enguantadas marcando el plan de incisión de un levantamiento con aumento de senos",
"A hand resting at the décolletage before a breast lift consultation":
...
"A surgeon marking muscle definition lines for high-definition liposuction":
  "Un cirujano marcando líneas de definición muscular para liposucción de alta definición",
...
"Pre-operative facial markings drawn before a deep plane facelift":
  "Marcas faciales preoperatorias antes de un levantamiento facial profundo",
...
"A gloved hand steadying the brow above a closed eye before lower-eyelid surgery":
  "Una mano enguantada sosteniendo la ceja sobre un ojo cerrado antes de una cirugía de párpado inferior",

# ---- head ----
"Plastic Surgery in Miami — Julio Clavijo Alvarez, MD":
  "Cirugía Plástica en Miami — Julio Clavijo Alvarez, MD",
"Board-certified plastic surgeon in Miami. Natural results and a recovery planned as carefully as the surgery. Request a consultation with Dr. Julio Clavijo Alvarez.":
  "Cirujano plástico certificado en Miami. Resultados naturales y una recuperación planificada con el mismo cuidado que la cirugía. Solicite una consulta con el Dr. Julio Clavijo Alvarez.",
})
...
# Anything still unmapped is a number, a username, a phone number, a duration,
# an email, or already Spanish — those pass through untouched by design.
...
T.update({
# ---- controls / aria ----
"Filter cases by procedure": "Filtrar casos por procedimiento",
"Cases, use arrow keys": "Casos, use las flechas del teclado",
"Previous case": "Caso anterior",
"Next case": "Caso siguiente",
"Previous procedures": "Procedimientos anteriores",
"More procedures": "Más procedimientos",
"Procedures, scrollable": "Procedimientos, deslizable",
...
"BBL + Lipo 360 result reel": "Reel de resultado: BBL + Lipo 360",
"Tummy Tuck + BBL result reel": "Reel de resultado: abdominoplastia + BBL",
"BBL + Breast Lift result reel": "Reel de resultado: BBL + levantamiento de senos",
"Breast Augmentation result reel": "Reel de resultado: aumento de senos",

# ---- credentials: institution names stay in English, they are proper nouns ----
...
# ---- reviews: two more that slipped the ellipsis test ----
"The pain has been at a minimum and Tylenol is all I've been taking since surgery. I was really nervous about the pain at first but turns out it's totally manageable.": None,
"From the initial consultation to the procedure to all of the follow-up appointments and care — he takes his time, explains everything, and truly cares about his patients.": None,
})
# None means: leave exactly as written. Used for verbatim patient quotes.

T.update({
"He has been explaining plastic surgery to camera for years &mdash; why implants harden, what a blood clot actually is, which facelift claims are marketing. The results below are from the same feed.":
  "Lleva años explicando cirugía plástica frente a la cámara &mdash; por qué se endurecen los implantes, qué es realmente un coágulo, qué promesas sobre el lifting facial son puro marketing. Los resultados de abajo vienen del mismo feed.",
"Forty-two talks on his channel: what each procedure actually involves, what recovery is honestly like, and the mistakes that cost people a good result. He publishes them free, in Spanish, whether or not you ever book.":
  "Cuarenta y dos charlas en su canal: en qué consiste realmente cada procedimiento, cómo es de verdad la recuperación, y los errores que le cuestan a la gente un buen resultado. Las publica gratis, en español, reserve o no una consulta.",
"Liposucción + Aumento de Senos result reel": "Reel de resultado: liposucción + aumento de senos",
"Primary": "Principal",
"Verified": "Verificado",
"Legal": "Legal",
})
