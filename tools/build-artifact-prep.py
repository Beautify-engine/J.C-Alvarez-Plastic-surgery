...
html = (ROOT / "preparation.html").read_text()
...
for src, real, mime in [
    ("/img/prep/marking-900.jpg",  "img/prep/marking-1400.webp", "image/webp"),
    ("/img/prep/preop-900.jpg",    "img/prep/preop-1400.webp",   "image/webp"),
    ("/img/prep/band-1200.jpg",    "img/prep/band-2000.webp",    "image/webp"),
...
html = re.sub(r'href="(/(?:book|results|procedures|about|videos|contact|privacy|accessibility)'
...
document.addEventListener('click', function (e) {
  ...
  n.textContent = a.dataset.route + ' \\u2014 not built yet. This is the Preparation preview.';
  n.hidden = false;
...
out = ('<title>Preparation & Recovery</title>\n'
       f"<style>\n{css}\n</style>\n{html}\n<script>\n{js}\n</script>\n")
pathlib.Path("design/artifact-preparation.html").write_text(out)
print(f"design/artifact-preparation.html  {len(out)/1024/1024:.2f} MB")
